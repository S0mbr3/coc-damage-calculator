...
"
	     ;; Equipements
	     ("h" coc-damage-calculatorfireball-hp-building-left :face coc-damage-calculator-hydra-command-face)
	     ...
	     ;; Spells
	     ("b" coc-damage-calculatorearthquake-hp-building-left :face coc-damage-calculator-hydra-command-face)
	     ("k" coc-damage-calculator-lightning-hp-building-left :face coc-damage-calculator-hydra-command-face)

	     ;; Combined
	     ("w" coc-damage-calculatorfireball-and-earthquake-calculator :face coc-damage-calculator-hydra-command-face)
	     ("d" coc-damage-calculatorfireball-earthquake-arrow-calculator :face coc-damage-calculator-hydra-command-face)
	     ("c" coc-damage-calculatorfireball-and-arrow-calculator :face coc-damage-calculator-hydra-command-face)
