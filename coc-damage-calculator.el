;;; coc-damage-calculator.el -- a damage calculator for various equipements, spells  of clash of clans
;;; -*- lexical-binding: t; -*-
;;; Commentary:
;; This package will help finding good combinations of spells, equipements to deal damage to buildings in clash of clans.
;;; Code:
...
(defun fireball-hp-building-left (level hp)
  ...
  (print (format "fireball building hp left: %d" (- hp (fireball-level-picker level)))))
